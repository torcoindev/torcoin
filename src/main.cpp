...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "U.S. wants tighter airport security";
        CTransaction txNew;
        txNew.nTime = 1404472420;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xb603ac088ca0e7ee06bcdf8691034dd3eb73986a6b48ff8fdb938e380158fd10"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xb1, 0xb2, 0xb3, 0xb9 };
